function plotValues(timeseriesObject, outputType, showSafetyLimits, showLegend)
    ...
    %         outputType       - 'BIS', 'RASS', 'NOL', 'CO', 'MAP', 'NMB'
    ...
    t_min = minutes(obj.Time*60);   % duration -> numeric minutes
    plot(t_min, obj.Variables);xlabel('Time (min)');
    ...
    switch outputType
        ...
        case OutputSignalType.NOL
            title('NOL'); ylabel('NOL');
            highSafetyValue = 25;
            lowSafetyValue = 10;
