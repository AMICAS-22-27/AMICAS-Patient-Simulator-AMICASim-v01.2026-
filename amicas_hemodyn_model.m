...
k1Pco = 0.81/60; k0Pco = 0.81; E0Pco = 5; EmaxPco = 5; gainPco=10; gammaPco = 4.5; C50Pco = 8;

%Interaction model from Propofol to MAP
k1Pmap = 0.61/60; k0Pmap = 0.81; E0Pmap = 5; EmaxPmap = 5; gainPmap=15; gammaPmap = 4.5; C50Pmap = 6;

%% Interaction Remi to hemodynamic
%Interaction model from Remi to CO
k1Rco = 0.51/60; k0Rco = 0.51; E0Rco = 15; EmaxRco = 5; gainRco=10; gammaRco = 4.5; C50Rco = 12;

%Interaction model from Remi to MAP
k1Rmap = 0.31/60; k0Rmap = 0.31; E0Rmap = 70; EmaxRmap = 15; gainRmap=10; gammaRmap = 4.5; C50Rmap = 17;

%% Hemodynamic model for a nominal patient
K11 = 5; tau11 = 300/60; T11 = 60/60; K21 = 12; tau21 = 150/60; T21 = 50/60; %dopamine
K12 = 3; tau12 = 40/60; T12 = 60/60; K22 = -15; tau22 = 40/60; T22 = 50/60; %snp
